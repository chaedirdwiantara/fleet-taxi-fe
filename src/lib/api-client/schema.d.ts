...
export interface paths {
    ...
    "/partner/portal/fleet/rental/grid": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Own Rental 31-day pivot — omset per plate per day, with payment status */
        get: operations["PortalFleetController_rentalGrid"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/partner/portal/deposit-installments/cop": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Car Ownership Program report: own COP-titled rules with programme figures */
        get: operations["DepositInstallmentsController_listCop"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        CreateDepositInstallmentDto: {
            ...
            /**
             * @description Durasi: jumlah cicilan harian (Nx). Program COP 60 bulan = 60 × 30 = 1800 cicilan.
             * @example 20
             */
...
export interface operations {
    ...
    PortalFleetController_rentalGrid: {
        parameters: {
            query: {
                month: number;
                year: number;
    ...
    DepositInstallmentsController_listCop: {
        parameters: {
            query?: {
                page?: string;
                pageSize?: string;
